...
for(i=1;i<=maxEmployee1Int-employee1Int;i++){
    ...
    const handCard = localStorage.getItem("handCard2");
...
$("button").click(function(){
    ...
    if(thisClass==="work-button1 button"){
        ...
        minusEmployee();
        DrawCard();
        localStorage.setItem("startPlayer",2);
        playerChange();
...
function minusEmployee(){
    var employeeValue=localStorage.getItem("employee2");
    var employee=parseInt(employeeValue)-1;
    localStorage.setItem("employee2",employee);
    window.location.reload();
}
function plusEmployee(){
    var employeeValue=localStorage.getItem("maxEmployee2");
    var employee=parseInt(employeeValue)+1;
    localStorage.setItem("maxEmployee2",employee);
    window.location.reload();
}
function DrawCard(){
    const handCard=localStorage.getItem("handCard2");
    ...
    a.push(random);
    localStorage.setItem("handCard2",JSON.stringify(a));
    window.location.reload();
}
